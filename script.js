...
const inverterSinal = () => {
    novoNumero = true;
    atualizarDisplay(parseFloat(display.textContent.replace(',', '.')) * -1);
}
...
const mapaTeclado = {
    ...
    'Enter': 'igual',
    'Backspace': 'backspace',
    'c': 'limparDisplay', // Made case consistent (changed 'C' to 'c')
    'Escape': 'limparCalculo', // Fixed typo 'Espace' to 'Escape'
    ',': 'decimal'
}
